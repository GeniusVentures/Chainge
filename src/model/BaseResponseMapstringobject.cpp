...
BaseResponseMapstringobject::BaseResponseMapstringobject() {
  m_Code = 0;
  m_CodeIsSet = false;
  m_DataIsSet = false;
...
void BaseResponseMapstringobject::validate() {
  // TODO: implement validation
}

web::json::value BaseResponseMapstringobject::toJson() const {
...
bool BaseResponseMapstringobject::fromJson(const web::json::value &val) {
  bool ok = true;
...
void BaseResponseMapstringobject::toMultipart(
...
bool BaseResponseMapstringobject::fromMultiPart(
    std::shared_ptr<MultipartFormData> multipart,
...
int32_t BaseResponseMapstringobject::getCode() const { return m_Code; }

void BaseResponseMapstringobject::setCode(int32_t value) {
  m_Code = value;
  m_CodeIsSet = true;
}

bool BaseResponseMapstringobject::codeIsSet() const { return m_CodeIsSet; }

void BaseResponseMapstringobject::unsetCode() { m_CodeIsSet = false; }
std::shared_ptr<Object> BaseResponseMapstringobject::getData() const {
  return m_Data;
}

void BaseResponseMapstringobject::setData(
    const std::shared_ptr<Object> &value) {
  m_Data = value;
  m_DataIsSet = true;
}

bool BaseResponseMapstringobject::dataIsSet() const { return m_DataIsSet; }

void BaseResponseMapstringobject::unsetData() { m_DataIsSet = false; }
utility::string_t BaseResponseMapstringobject::getMsg() const { return m_Msg; }

void BaseResponseMapstringobject::setMsg(const utility::string_t &value) {
  m_Msg = value;
  m_MsgIsSet = true;
}

bool BaseResponseMapstringobject::msgIsSet() const { return m_MsgIsSet; }

void BaseResponseMapstringobject::unsetMsg() { m_MsgIsSet = false; }
int32_t BaseResponseMapstringobject::getStatus() const { return m_Status; }

void BaseResponseMapstringobject::setStatus(int32_t value) {
  m_Status = value;
  m_StatusIsSet = true;
}

bool BaseResponseMapstringobject::statusIsSet() const { return m_StatusIsSet; }

void BaseResponseMapstringobject::unsetStatus() { m_StatusIsSet = false; }
} // namespace model
} // namespace client
} // namespace openapitools
} // namespace org
